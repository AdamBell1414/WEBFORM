<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="BilklPaymentWenFormPortal.AdminPages.AdminDashboard" %>
...
<ul class="nav flex-column">
    ...
    <asp:Label ID="Label3" runat="server" CssClass="text-success mb-2" EnableViewState="false" />
        ...
        <div class="modal fade" id="userModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Vendor Modal Message Label -->
<asp:Label ID="lblVendorMessage" runat="server" CssClass="text-success mb-2" EnableViewState="false" />
