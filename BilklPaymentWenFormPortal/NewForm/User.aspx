<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="BilklPaymentWenFormPortal.NewForm.User" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>User Portal - BilklPayment</title>
        ...
        <div class="layout">
            ...
            <div class="sidebar">
                <div class="sidebar-header">
                    <h1><i class="fas fa-store me-2"></i>User Portal</h1>
                    <p>Manage your User  operations and customer relationships efficiently</p>
                </div>
                ...
                <div class="main-content">
                    ...
                    <div class="stats-grid">
                        <div class="stat-card">
                            <div class="stat-card-header">
                                <h5 class="stat-card-title">Total Transtion</h5>
                 ...
                 <%--   <div id="list" class="section">
                        <div class="section-header">
                            <h4><i class="fas fa-users me-2"></i> See All  Transtions</h4>
                            <p> Transtions</p>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:DropDownList ID="ddlUtilities" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlUtilities_SelectedIndexChanged">
                                  ...
                                  <%--  <asp:ListItem Text="InMTN" Value="MTN|25.00" />--%>
                            ...
                            <!-- Payment Amount -->
                            <div class="col-md-6">
                                <label class="form-label"><i class="fas fa--sign me-1"></i>Amount to Pay (UGX)</label>
